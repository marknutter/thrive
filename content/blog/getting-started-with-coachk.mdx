---
title: "Getting Started with CoachK"
date: "2026-02-20"
excerpt: "Learn how to set up your CoachK project, configure authentication, and deploy your first app in under 10 minutes."
author: "CoachK Team"
tags: ["getting-started", "tutorial"]
published: true
---

# Getting Started with CoachK

CoachK is a production-ready Next.js starter that gives you everything you need to build and ship a modern web application. In this guide, we'll walk through the initial setup, key features, and how to make it yours.
...
```bash
git clone https://github.com/your-org/coachk.git my-app
cd my-app
npm install
```
...
CoachK uses [Better Auth](https://www.better-auth.com/) for authentication. It supports:
...
CoachK includes Docker configuration for easy deployment:
