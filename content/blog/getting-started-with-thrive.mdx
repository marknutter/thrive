...
date: "2026-02-20"
excerpt: "Learn how to set up your Thrive project, configure authentication, and deploy your first app in under 10 minutes."
author: "Thrive Team"
...
Thrive is a production-ready Next.js starter that gives you everything you need to build and ship a modern web application. In this guide, we'll walk through the initial setup, key features, and how to make it yours.
...
```bash
git clone https://github.com/your-org/thrive.git my-app
cd my-app
npm install
```
...
Thrive uses [Better Auth](https://www.better-auth.com/) for authentication. It supports:
...
Thrive includes Docker configuration for easy deployment:
